...
import '../ringtone/flutter_ringtone_player.dart';
    ...
    class _DocDashboardState extends State<DocDashboard> with SingleTickerProviderStateMixin {
        ...
        return showDialog(
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              content: Text('You have an incoming call. Do you want to answer it?'),
              actions: <Widget>[
                TextButton(
                  child: Text('Reject'),
                  onPressed: () async {
    ...
    Widget build(BuildContext context) {
      return Scaffold(
        ...
        body: DefaultTabController(
          length: 3, // Adjust the length based on the number of statuses
          child: Column(
            children: [
              TabBar(
                controller: _tabController,
